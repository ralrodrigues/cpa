...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { nome: @area.nome, questionario_id: @area.questionario_id, usuario_id: @area.usuario_id }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: { nome: @area.nome, questionario_id: @area.questionario_id, usuario_id: @area.usuario_id }
    assert_redirected_to area_path(assigns(:area))
  end
