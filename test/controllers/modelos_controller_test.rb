...
class ModelosControllerTest < ActionController::TestCase
  ...
  test "should create modelo" do
    assert_difference('Modelo.count') do
      post :create, modelo: { nome: @modelo.nome, questionario_id: @modelo.questionario_id, visibilidade: @modelo.visibilidade }
    end
  ...
  test "should update modelo" do
    patch :update, id: @modelo, modelo: { nome: @modelo.nome, questionario_id: @modelo.questionario_id, visibilidade: @modelo.visibilidade }
    assert_redirected_to modelo_path(assigns(:modelo))
  end
