...
class DisciplinasControllerTest < ActionController::TestCase
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post :create, disciplina: { curso_id: @disciplina.curso_id, nome: @disciplina.nome, qtd_professores: @disciplina.qtd_professores, sigla: @disciplina.sigla }
    end
  ...
  test "should update disciplina" do
    patch :update, id: @disciplina, disciplina: { curso_id: @disciplina.curso_id, nome: @disciplina.nome, qtd_professores: @disciplina.qtd_professores, sigla: @disciplina.sigla }
    assert_redirected_to disciplina_path(assigns(:disciplina))
  end
