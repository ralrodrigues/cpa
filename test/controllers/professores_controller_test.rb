...
class ProfessoresControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { area_id: @professor.area_id, email: @professor.email, nome: @professor.nome, prontuario: @professor.prontuario, usuario_id: @professor.usuario_id }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { area_id: @professor.area_id, email: @professor.email, nome: @professor.nome, prontuario: @professor.prontuario, usuario_id: @professor.usuario_id }
    assert_redirected_to professor_path(assigns(:professor))
  end
