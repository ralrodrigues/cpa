...
class TurmasControllerTest < ActionController::TestCase
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post :create, turma: { disciplina_id: @turma.disciplina_id, professor_id: @turma.professor_id, sigla: @turma.sigla }
    end
  ...
  test "should update turma" do
    patch :update, id: @turma, turma: { disciplina_id: @turma.disciplina_id, professor_id: @turma.professor_id, sigla: @turma.sigla }
    assert_redirected_to turma_path(assigns(:turma))
  end
